...
export default function LandingNavbar() {
    const { isLoggedIn, login, name, level, logout } = useAuth();
            ...
            <div className="w-[88%] h-auto flex flex-row justify-between items-center">
                ...
                {isLoggedIn ? (
                    <button 
                        ...
                        className="flex flex-row gap-1 items-center will-change-transform hover:scale-110 active:scale-95 transition-transform duration-200 ease-in-out"
                    >
                    ...
                    <Link 
                        href="/auth" 
                        className="w-auto flex flex-row gap-2 items-center hover:text-blue-600 transition-colors duration-200"
                    >
